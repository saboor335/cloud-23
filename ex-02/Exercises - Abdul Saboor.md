...
1. Provide URL to the docker file. I.e.:%giturl%\Source\MyCloudProjectSample\MyCloudProject\Dockerfile
    ...
    %giturl%/Source/MyCloudProjectSample/Documentation/Exercise/Ex2/DockerApp/Dockerfile

3. Provide the URL to the publich image in the Docker Hub.

    docker pull saboor123abdul/dockerapp:v1
